...
function MinhasInformacoesCard($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		*/
		...
		if (carregandoEstatisticas) {
			...
			for (let $$index_4 = 0, $$length = each_array_3.length; $$index_4 < $$length; $$index_4++) {
				...
				for (let $$index_3 = 0, $$length = each_array_4.length; $$index_3 < $$length; $$index_3++) {
					...
					$$renderer.push(`<div${attr_class(`heatmap-dia nivel-${stringify(nivelHeatmap(dia.quantidade))}`, "svelte-1y1b6km", { "fora-do-ano": dia.foraDoAno })}${attr("title", `${stringify(dia.data)}: ${stringify(dia.quantidade)} agendamento(s)`)}></div>`);
				}
				$$renderer.push(`<!--]-->`);
			}
		...
		$$renderer.push(`<!--]--></div> `);
		if (usuario?.cargo === "educador") {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<div class="card" id="grade"><div class="card-header"><span class="material-symbols-outlined">calendar_month</span> <h3>Minha Grade de Aulas</h3></div> `);
		...
		$$renderer.push(`<!--]--> <div class="card" id="agendamentos"><div class="card-header"><span class="material-symbols-outlined">event_available</span> <h3>Meus Agendamentos</h3></div> `);
